                    ...
                    <div className="w-full">
                      ...
                      >
                        <div className="mb-6 flex items-center gap-3">
                          ...
                          <h3 style={{ fontFamily: 'var(--font-sans)', fontSize: '24px', fontWeight: 'bold' }} className="text-slate-800 uppercase tracking-widest font-sans font-bold">LK BÁN KÈM NHÂN VIÊN</h3>
                        </div>
                        <div className="overflow-x-auto">
                          <table className="w-full text-left font-sans text-slate-800 border-collapse border-2 border-slate-300">
                            <thead className="text-white uppercase border-b-2 border-slate-300">
                              <tr>
                                <th style={{ width: '240px', fontFamily: 'var(--font-sans)', fontSize: '16px', fontWeight: 'bold' }} className="px-6 py-[11px] border-r-2 border-slate-300 bg-emerald-600 font-sans font-bold">NHÂN VIÊN</th>
                                <th style={{ width: '70px', fontFamily: 'var(--font-sans)', fontSize: '13px', fontWeight: 'bold' }} className="px-6 py-[11px] text-center border-r-2 border-slate-300 bg-orange-300 text-slate-800 font-sans font-bold">DTLK</th>
                                <th style={{ width: '70px', fontFamily: 'var(--font-sans)', fontSize: '13px', fontWeight: 'bold' }} className="px-6 py-[11px] text-center border-r-2 border-slate-300 bg-orange-300 text-slate-800 font-sans font-bold">LƯỢT BILL BÁN KÈM</th>
                                <th style={{ width: '70px', fontFamily: 'var(--font-sans)', fontSize: '13px', fontWeight: 'bold' }} className="px-6 py-[11px] text-center border-r-2 border-slate-300 bg-orange-300 text-slate-800 font-sans font-bold">%BILL BÁN KÈM</th>
                                <th style={{ width: '70px', fontFamily: 'var(--font-sans)', fontSize: '13px', fontWeight: 'bold' }} className="px-6 py-[11px] text-center border-r-2 border-slate-300 bg-orange-300 text-slate-800 font-sans font-bold">LƯỢT BILL BÁN HÀNG (TRỪ ONLINE, TRẢ GÓP)</th>
                                <th style={{ width: '70px', fontFamily: 'var(--font-sans)', fontSize: '13px', fontWeight: 'bold' }} className="px-6 py-[11px] text-center bg-orange-300 text-slate-800 font-sans font-bold">HIỆU QUẢ</th>
                              </tr>
                            </thead>
