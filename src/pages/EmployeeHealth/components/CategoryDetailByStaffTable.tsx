                  ...
                  <table className="w-full border-separate border-spacing-0 border-t border-l border-slate-300 min-w-[600px]">
                    <thead>
                      <tr className="text-slate-900 h-[53px]">
                        <th className="px-1 py-2.5 text-[16px] font-utm-avo font-black uppercase tracking-tight text-center border-r border-b border-slate-300 bg-[#10b981] w-[40px] min-w-[40px] whitespace-nowrap">STT</th>
                        ...
                        <th className="px-1 py-2.5 text-[16px] font-utm-avo font-black uppercase tracking-tight text-center border-r border-b border-slate-300 bg-[#f97316] w-[75px] min-w-[75px] whitespace-nowrap">TARGET</th>
                        <th className="px-1 py-2.5 text-[16px] font-utm-avo font-black uppercase tracking-tight text-center border-r border-b border-slate-300 bg-[#f97316] w-[75px] min-w-[75px] whitespace-nowrap">LUỸ KẾ</th>
                        <th className="px-1 py-2.5 text-[16px] font-utm-avo font-black uppercase tracking-tight text-center border-r border-b border-slate-300 bg-[#f97316] w-[90px] min-w-[90px] whitespace-nowrap">%HT (DK)</th>
                      </tr>
                    </thead>
                    <tbody>
                      {rowData.map((row, index) => {
                        ...
                        return (
                          ...
                          >
                            <td className="px-1 py-2.5 text-[17px] font-utm-avo font-black text-slate-800 text-center border-r border-b border-slate-300 w-[40px] min-w-[40px] h-full">
                              {index + 1}
                            </td>
                            ...
                            <td className="px-1 py-2.5 text-[17px] font-utm-avo font-black text-center border-r border-b border-slate-300 text-slate-900 w-[75px] min-w-[75px] h-full">
                              {row.target.toLocaleString('vi-VN', { maximumFractionDigits: 1 })}
                            </td>
                            <td className="px-1 py-2.5 text-[17px] font-utm-avo font-black text-center border-r border-b border-slate-300 text-[#b91c1c] w-[75px] min-w-[75px] h-full">
                              {row.accumulated.toLocaleString('vi-VN', { maximumFractionDigits: 1 })}
                            </td>
                            <td className={cn(
                              "px-1 py-2.5 text-[17px] font-utm-avo font-black text-center border-r border-b border-slate-300 w-[90px] min-w-[90px] h-full",
                              roundedRate >= 100 
