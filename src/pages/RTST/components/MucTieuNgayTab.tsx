              ...
              {displayedCategoryList.map((item, idx) => {
                ...
                return (
                  <tr key={item.key || idx} className={`${isEven ? 'bg-white' : 'bg-emerald-50/20'} hover:bg-emerald-50/50 transition-colors h-[40px]`}>
                    ...
                    <td style={{ maxWidth: 0, overflow: 'hidden' }} className="px-1.5 py-0 font-black text-slate-900 border border-emerald-100 uppercase tracking-tight overflow-hidden" title={item.name}>
